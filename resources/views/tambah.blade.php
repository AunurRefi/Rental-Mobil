  ...
  <div class="content"> 
    <table style="width:75%">
      <tr>
        <td>Id Pesan</td>
        <td>
         <form action="pinjaminput" method="post" onsubmit="submitForm()">
...
$b = rand(0,9);
if ($a<100000) {
  $kode =  "TKODE-".$b.substr($a,0,5);
}
elseif ($a<10000) {
  $kode = "TKODE-".$b.$b.substr($a,0,4);
}
elseif ($a<1000) {
  $kode = "TKODE-".$b.$b.$b.substr($a,0,3);
}
elseif ($a<100) {
  $kode = "TKODE-".$b.$b.$b.$b.substr($a,0,2);
}
elseif ($a<10) {
  $kode = "TKODE-".$b.$b.$b.$b.$b.substr($a, 0,1);
}
else {
   $kode = "TKODE-".$a;
}
...
?>
      ...
      <tr>
        <td><input type="hidden" name="id_pesan" value="{{ $kode }}"></td>
      ...
      <tr>
        ...
        <p>
          <div class="input-control text full-size">
            <input style="width:100%;height:35px;" type="text" name="nama">
          </div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <p>
          <div class="field">
            <input onchange="totalharga()" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask="" id="tanggalPinjam" style="height:35px; width:100%;" type="text" name="tanggal_pinjam">
          </div>
        </td>
      </tr>
      <tr>
        ...
        <p>
          <div class="field">
          <input onchange="totalharga()" data-inputmask="'alias': 'yyyy/mm/dd'" data-mask="" id="tanggalKembali" style="height:35px; width:100%;" type="text" name="tanggal_kembali">
          </div>
        </td>
      </tr>
      <tr>
        ...
        <p>
          ...
          <select style="width:100%;height:35px;" name="merek_mobil">
      ...
      <tr>
        ...
        <p>
          <div class="input-contol text full-size">
            <input onchange="totalharga()" id="hargaMobil" type="text" style="width:30%" name="harga_mobil" readonly>
          </div>
        </td>
      </tr>
      <tr>
        ...
        <p>
          <div class="input-contol text full-size">
            ...
            <input checked="checked" name="status" type="radio" value="Belum Dibayar ">Belum Dibayar
          </div>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <p>
          <div class="input-contol text full-size">
          <input readonly type="text" style="width:30%" name="total_harga">
          </div>
        </td>
      </tr>
      </table>
    ...
    <script type="text/javascript">
      function  totalharga(){
        ...
        if($("select[name='nama_mobil']").val() == "pilihmobil"){
    ...
    <script type="text/javascript">
      $(function(){
        ...
        $("input[name='harga_mobil']").change(function(e){
            totalharga();
        }); 
      });
